...
(function(){
    ...
    function ConanjsTips(option){
         ...
         *  @type   {Object}
         */
        param.target = this.target = option.target || null;
        /**
         *  提示窗口是否弹出显示（支持弹窗和在页面里直接显示两种方式）,默认弹出
         *
         *  @type   {Boolean}
         */
        param.isPopup = this.isPopup = option.isPopup || false;
        /**
         *  提示窗口是否会定时自动消失，默认不消失
         *
         *  @type   {Boolean}
         */
        param.isDisappear = this.isDisappear = option.isDisappear || false;
        /**
         *  提示窗口的显示方式（支持show/hide; 弹跳）
         *
         *  @type   {String}
         */
        param.displayMode = this.displayMode = option.displayMode || 'default';
        /**
         *  是否需要关闭窗口的按钮
         ...
         *  @type   {Boolean}
         */
        param.isCloseIcon = this.isCloseIcon = option.isCloseIcon || false;
        /**
         *  弹窗的内容(默认为空)
         *
         *  @type   {String}
         */
        param.content = this.content = option.content || '';
        /**
         *  弹窗的显示时间，默认为2000毫秒，只有isDisappear = true 时这个才会解析
         *
         *  @type   {Number}
         */
        param.spacing = this.spacing = option.spacing || 2000;

        /**
         *  显示窗口
         */
        param.show = this.show = function(){
         ...
         *  @type   {String}
         */
        param.reload = this.reload = function(content){
